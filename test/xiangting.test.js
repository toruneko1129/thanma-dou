...
suite('Majiang.Util', ()=>{
    ...
    suite('xiangting_yiban(shoupai)', ()=>{
        ...
        test('聴牌形', ()=>
            assert.equal(Majiang.Util.xiangting_yiban(
                            Majiang.Shoupai.fromString('m123p406s789z1122')),
                            0));
        test('和了形', ()=>
            assert.equal(Majiang.Util.xiangting_yiban(
                            Majiang.Shoupai.fromString('m123p456s789z11222')),
                            -1));
        test('副露あり', ()=>
            assert.equal(Majiang.Util.xiangting_yiban(
                            Majiang.Shoupai.fromString('m123p456s789z2,z111=')),
                            0));
        test('雀頭なし', ()=>
            assert.equal(Majiang.Util.xiangting_yiban(
                            Majiang.Shoupai.fromString('m12389p456s12789z1')),
                            1));
        test('搭子過多', ()=>
            assert.equal(Majiang.Util.xiangting_yiban(
                            Majiang.Shoupai.fromString('m12389p456s1289z11')),
                            1));
        test('搭子不足', ()=>
            assert.equal(Majiang.Util.xiangting_yiban(
                            Majiang.Shoupai.fromString('m133345568z23677')),
                            2));
        test('多牌: 5面子', ()=>{
        ...
        test('少牌: 雀頭なし4面子', ()=>
            assert.equal(Majiang.Util.xiangting_yiban(
                            Majiang.Shoupai.fromString('p234s567,m222=,p0-67')),
                            1));
        test('刻子＋順子', ()=>
            assert.equal(Majiang.Util.xiangting_yiban(
                            Majiang.Shoupai.fromString('p222345z1234567')),
                            4));
        test('順子＋孤立牌＋順子', ()=>
            assert.equal(Majiang.Util.xiangting_yiban(
                            Majiang.Shoupai.fromString('p2344456z123456')),
                            4));
        test('対子＋刻子＋順子', ()=>
            assert.equal(Majiang.Util.xiangting_yiban(
                            Majiang.Shoupai.fromString('p11222345z12345')),
                            3));
        test('対子＋順子＋順子＋対子', ()=>
            assert.equal(Majiang.Util.xiangting_yiban(
                            Majiang.Shoupai.fromString('p2234556788z123')),
                            2));
        test('副露直後の牌姿が和了形', ()=>
            assert.equal(Majiang.Util.xiangting_yiban(
                            Majiang.Shoupai.fromString(
        ...
        test('一般手: 10000パターン', ()=>{
            for (let data of data1) {
                ...
                assert.equal(Majiang.Util.xiangting_yiban(shoupai),
                             data.x[0], shoupai);
            }
        });
        test('混一手: 10000パターン', ()=>{
    ...
    suite('xiangting_guoshi(shoupai)', ()=>{
        ...
        test('幺九牌なし', ()=>
            assert.equal(Majiang.Util.xiangting_guoshi(
                            Majiang.Shoupai.fromString('m23455p345s45678')),
                            13));
        test('雀頭なし', ()=>
            assert.equal(Majiang.Util.xiangting_guoshi(
                            Majiang.Shoupai.fromString('m189p12s249z12345')),
                            4));
        test('雀頭あり', ()=>
            assert.equal(Majiang.Util.xiangting_guoshi(
                            Majiang.Shoupai.fromString('m119p12s299z12345')),
                            3));
        test('聴牌形', ()=>
            assert.equal(Majiang.Util.xiangting_guoshi(
                            Majiang.Shoupai.fromString('m11p19s19z1234567')),
                            0));
        test('聴牌形(13面張)', ()=>
            assert.equal(Majiang.Util.xiangting_guoshi(
        ...
        test('副露あり', ()=>
            assert.equal(Majiang.Util.xiangting_guoshi(
                            Majiang.Shoupai.fromString('m19p19s19z1234,z777=')),
                            Infinity));
        test('多牌', ()=>
            assert.equal(Majiang.Util.xiangting_guoshi(
                            Majiang.Shoupai.fromString('m19p19s19z12345677')
                                            .zimo('m1', false)),
                            -1));
        test('少牌', ()=>
            assert.equal(Majiang.Util.xiangting_guoshi(
                            Majiang.Shoupai.fromString('m119p19s19z12345')),
                            1));

        test('一般手: 10000パターン', ()=>{
            for (let data of data1) {
                const shoupai = new Majiang.Shoupai(data.q);
                assert.equal(Majiang.Util.xiangting_guoshi(shoupai),
                             data.x[1], shoupai);
            }
        });
        test('混一手: 10000パターン', ()=>{
    ...
    suite('xiangting_qidui(shoupai)', ()=>{
        ...
        test('一般手: 10000パターン', ()=>{
            for (let data of data1) {
                const shoupai = new Majiang.Shoupai(data.q);
                assert.equal(Majiang.Util.xiangting_qidui(shoupai),
                             data.x[2], shoupai);
            }
        });
        test('混一手: 10000パターン', ()=>{
    ...
    suite('tingpai(shoupai, f_xiangting)', ()=>{

        test('打牌可能な状態のとき、エラーとなること', ()=>{
            assert.ifError(Majiang.Util.tingpai(
                                Majiang.Shoupai.fromString(
                                                    'm123p456s789z12345')));
            assert.ifError(Majiang.Util.tingpai(
                                Majiang.Shoupai.fromString(
